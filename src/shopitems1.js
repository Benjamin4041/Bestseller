...
export default function shopitems1({productName,brand,price,image}) {
  return (
    <div style={{display:"flex",alignItems:"center",backgroundColor:"#FEF2EE",height:"20%",borderRadius:"24px",padding:"0em 2em",columnGap:"2em"}}>
        <img src={image} alt="" />
        <div>
